...
function ondirectionChange(event){
	...
	document.getElementById("myLabel").innerHTML = "Distance to object: " + distanceToTree+" meters";
	const height = Math.tan(angle*Math.PI/100)*distanceToTree;
	document.getElementById("heightdetail").innerHTML = height.toFixed(1) + " m(" +angle.toFixed(1) + "&deg;)";
	}